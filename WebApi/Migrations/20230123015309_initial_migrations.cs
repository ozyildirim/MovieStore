    ...
    public partial class initialmigrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PurchasedCustomersCustomerId = table.Column<int>(type: "integer", nullable: false),
                    PurchasedMoviesId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerMovie", x => new { x.PurchasedCustomersCustomerId, x.PurchasedMoviesId });
                    table.ForeignKey(
                        name: "FK_CustomerMovie_Customers_PurchasedCustomersCustomerId",
                        column: x => x.PurchasedCustomersCustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerMovie_Movies_PurchasedMoviesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerMovie_PurchasedMoviesId",
                table: "CustomerMovie",
